...
**Today's Progress**: Completed my Random Quote Machine project for freeCodeCamp. Also, worked on the other projects for my Front End Libraries Certification. Additionally, progressing through the Reporting with SQL course by Team Treehouse.

**Thoughts:** In order to stay consistent with my coding, I am going to give up what makes me skip days for the remainder of this challenge. If I am not messing around, then there is a greater chance that I will code. Today was my most productive Sunday in like seven weeks, which is the majority of this challenge. Not surprisingly, today my chess scores are near the highest they have been in the past thirty days (I belive there is a correlation between the consistency how often I code with how high my chess scores are). I completed the styling and added logic for the random number selection for my Random Quote Project. It is not where it should be, but for right now, I am fine with it. Best not to worry about the small things and keep moving forward toward completing the bigger things (like finally obtaining the Front End Libraries Certification). I reread Chapter 14 of Eloquent JavaScript and redid the accompanying exercises. Fortunately, despite it being a month since I worked through this chapter, I was able to easily complete the exercises. Lastly, I began styling my Pomodoro Project. I took checked out some examples of other Pomodro Clocks, not the code but just what appeared on the browser, and I tried to implement it myself. 

**Links to work:**
- [Random Quote Machine](https://github.com/iccir919/random-quote-machine)
...
**Thoughts:** Today I was added some style to my Random Quote Machine project. There are lights that surround the quote. I added some animation to make the lights turn on and off, emulating the behavior of a movie marquee. I was only able to accomplish such an effect thanks to a workshop by Team Treehouse. I have never put animation into any of my projects before so I am happy that I finally did. Sometimes a concept like animation with CSS can seem so intimidating until I just suck it up and try it out. Even though I had the whole day to work on anything, I did not utilize like I should have. Not making any programming progress on Saturday has been my typical behavior for about the past seven weeks, which is the majority of this challenge. I am happy that I did a little bit of work, I would have liked to do more, but something is better than nothing. This next week, starting tomorrow, I will completely focus on making progress on freeCodeCamp and Code Signal and contributing code to Github every day of the week!
